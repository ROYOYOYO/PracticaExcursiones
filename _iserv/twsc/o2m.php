<?php
	...
	$BACKUP_ORDER	= true;		
	$MERCHANT_TO	= "<71960412@continental.edu.pe>";		
	$MERCHANT_FROM	= "<71960412@continental.edu.pe>";	
	$MERCHANT_BCC 	= true;		
	$MERCHANT_DATE_FORMAT = "dd/mm/yyyy";	
	$CRLF 			= "\r\n";				
	$HTTP_PREFIX	= (false)?'https://':'http://';		
	$VO_CTR = "afb1942c367449107f790e73809643d8";					
	$MAX_PERIOD = -1;				
	$ORDER_EMAIL_ADD_URL = false;		
	$ACCOUNTS_URL = "";
	$COOKIE_ACCOUNT_INF = "63e2-account_inf";
